...
<div>
  <h2 class="mb-5 text-3xl font-normal text-declaration">
  ...
  {:then repositories}
    {#if repositories.length > 0}
      {#each repositories as repository}
        <div
          class="mb-3 flex items-center justify-between border-b border-gray-500 pb-3"
        >
          <div class="flex-1">
            <a
          ...
          <div
            class="ml-1.5 flex min-w-[30px] items-center space-x-2 text-white"
          >
