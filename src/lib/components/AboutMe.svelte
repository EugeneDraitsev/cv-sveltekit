...
<div class="px-2">
	...
	<p class="my-8">
		...
		engineer diploma from BSUIR in 2013. Almost all my experience has been as a fullstack developer
		(Node/Java + Frontend). I really like functional programming, serverless approach and cloud
		platforms. Currently, I'm working as a fullstack developer, mainly with Svelte, React,
		TypeScript, k8s, and AWS/GCP
	</p>
	<p class="my-6">
		You can find my
		<a
